...
import ConteudoSessaoFinal from '../../utils/traducao/conteudoSessaoFinal';

export default function SessaoFinal({ refSessaoFinal, corFundo, corTexto }) {
    ...
    const [conteudo, setConteudo] = useState(ConteudoSessaoFinal(idiomaContext));

    useEffect(() => {
        // console.log(idiomaContext);
        setConteudo(ConteudoSessaoFinal(idiomaContext));
    ...
    return (
        <section className={Styles.section} ref={refSessaoFinal} style={{ backgroundColor: corFundo, color: corTexto }}>

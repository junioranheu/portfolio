import { faBootstrap, faCss3Alt, faGitAlt, faHtml5, faJsSquare, faPhp, faReact } from '@fortawesome/free-brands-svg-icons';
    ...
    return (
        <div className={Styles.browser}>
            ...
            <div className={`${Styles.browserContent} ${Styles.addOverflow}`}>
                ...
                <SkillRow Icone={faPhp} item='PHP' qtdEstrelas={3} cor={'#777BB3'} />
